...
func predictLocalAndSystem(a complete.Args) []string {
	...
	// System directories are not actual file names, for example: 'github.com/gechr/complete' could
	// be the argument, but the actual filename is in $GOPATH/src/github.com/gechr/complete'. this
